...
namespace BookClub.Areas.Identity.Pages.Account
{
    public class RegisterModel : PageModel
    {
        ...
        public class InputModel
        {
            ...
            /// </summary>
            [Required]
            [StringLength(100, ErrorMessage = "Длина  должна быть не менее двух и не более одного символов.", MinimumLength = 6)]
            ...
            [Required]
            [StringLength(25, ErrorMessage = "Длина  должна быть не менее {2} и не более {1} символов.", MinimumLength = 5)]
